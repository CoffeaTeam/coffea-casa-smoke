...
# This is a simple ROOT macro that creates and fills a few histograms
# and a ntuple with random numbers, and saves them into a ROOT file.
# Original code is here: https://root.cern/doc/v632/hsimple_8py.html
