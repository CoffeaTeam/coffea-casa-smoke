...
# Code is taken from the ROOT RDataFrame distributed tutorial using Dask with an existing cluster
# https://root.cern/doc/v6.28/tutorials/dataframe/distrdf002_dask_connection.html
# %%
...
def create_connection():
    ...
    In this tutorial, a cluster object is created for user on coffea-casa and we are always 
    using "tls://localhost:8786" for any user instance.
    """
    client = Client("tls://localhost:8786")
    return client
 
 
# This tutorial uses RDataframe with Dask, to configure a Dask connection and fill two histograms distributedly. 
# Original code is here: https://root.cern/doc/v632/distrdf002__dask__connection_8py.html
...
if __name__ == "__main__":
    ...
    df = ROOT.RDF.Experimental.Distributed.Dask.RDataFrame(1000, daskclient=connection)
